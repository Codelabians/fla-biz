                ...
                <div class="col-sm-4">
                    <div class="well">
                        <form id="formid1" class="form-horizontal" action="" method="POST">
                            ...
                            <p><input id="ckagree" class="ckagree" name="ckagree" type="checkbox" checked="checked"><span class="price">
                            <?php
                                $price = "$65";
                                if ($_POST['Redeem']){
                                ...
                                if ($existing_customer==0){
                                    ...
                                    } ?><span style="color:green;"><?= $price ?></span>Copyright Application and <br>$35 for Single Application (single author, one work, not for hire) $55 for Standard Application (all other filings)</p>
