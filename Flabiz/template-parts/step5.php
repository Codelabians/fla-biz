    ...
    <div class="row d-flex">
        <div class="col-sm-12 col-md-10 col-lg-8">
            <form data-action="step-six" id="myForm" class=" m-3">
                ...
                <div class="indent-wrap m-5 ">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-lg-9 col-sm-12">
                            <input class="form-control shares" data-required="true" data-error="shares is required"
                ...
                <div class="form-row form-group m-3">
                    <div class="ml-md-auto col-sm-12">
                        <input type="checkbox" id="chekbox4" value="Custom stock certificates and corporate seals - $49"
                            name="chekbox4">
                        <label for="">
                ...
                <div class="form-row form-group m-3">
                    <div class="ml-md-auto col-sm-12">
                        ...
                        <label for="chekbox5">
                            <span>Corporate kit with bylaws, minutes, a Florida Business Guide, and a personalized
                                binder for all corporate documents - $20</span>
                        </label>
                    </div>
                </div>
                <div class="form-row form-group m-3">
                ...
                <div class="ml-md-auto col-sm-12 d-flex">
                    <div class="box-checkbox border border-success m-2 ">
                        <input class="custom-control-input m-2 " value="i neend file for EIN" type="checkbox"
                            id="chekbox7" name="chekbox7">
                        <label for="chekbox7">
                            <span>
