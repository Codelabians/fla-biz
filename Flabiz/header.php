...
<link rel="shortcut icon" href="http://copyrightregistry-online-form.com/wp-content/themes/custom/images/bullet-icon.png" type="image/x-icon">
      ...
      <link rel="apple-touch-icon" sizes="114x114" href="http://copyrightregistry-online-form.com/wp-content/themes/custom/images/bullet-icon.png">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="nav navbar-nav ms-auto">
                    ...
                    ?>
                        <li><a href="/record" class="scroll nav-link text-white"><?= ucfirst($user->data->user_nicename) ?></a></li>
