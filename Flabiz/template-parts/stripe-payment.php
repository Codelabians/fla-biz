...
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/bootstrap-formhelpers-min.css" media="screen">
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/bootstrapValidator-min.css"/>
<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" />
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/bootstrap-side-notes.css" />
<style type="text/css">
.col-centered {
...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_test_9kiwbx2oOT2xUMD61WraXR26');
...
if ($_POST) {
  Stripe::setApiKey("sk_test_HF53OCwCIdCjeini7eARTT7U");
  $error = '';
  $success = '';
...
?>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" name="amount" id="amount" maxlength="15" placeholder="Amount" class="amount form-control" required>
      </div>
    </div>
