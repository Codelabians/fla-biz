        ...
        <div class="col-sm-12 col-md-10 col-lg-8">
            <form data-action="step-10" id="myForm" class=" m-3">
                ...
                <div class="form-outline">
                    ...
                    <input type="text" id="CVV" data-error="CVN/CVV is required" class="form-control" data-required="true" />
                </div>
                <div class="form-outline">
                    <label class="form-label" for="Expiration">Expiration</label>
                    <input type="date" id="Expiration" data-error="Expiration is required" class="form-control" data-required="true" />
                </div>
