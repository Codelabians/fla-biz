            ...
            <form data-action="#" id="myForm" class=" m-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-12 d-flex">
                        ...
                        <i class="password-toggle  bg-light p-2 border text-center d-block justify-content-center  " style="height: 44px; cursor:pointer;"  onclick="togglePasswordVisibility()">
